          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ livestorage_asset('themes/AdminLTE/index.html') }}"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                <li><a href="{{ livestorage_asset('themes/AdminLTE/index2.html') }}"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li><a href="{{ livestorage_asset('themes/AdminLTE/documentation/index.html') }}"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
